...
**この主張が崩れる条件**: AI市場が寡占(少数の会社で市場が固まる状態)で安定して首位が複数年固定され、かつ乗り換えで得られる性能・価格の利得が可換性維持コストを下回り続けることが実測で示されたとき、可換性投資は過剰な保険となり「最有力ベンダーへの深い適合」が最適解になる。
...
2026-06-12 平易化取りこぼし点検: 作業仮説・寡占に言い換えを追加。事実・数値・出典タグは不変。
-->
